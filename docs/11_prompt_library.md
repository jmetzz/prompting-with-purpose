...
- **Write in Your Style:** Use this prompt to have the AI analyze your writing and then generate new content that matches your unique voice and tone. This leverages the AI's ability to understand and replicate stylistic nuances, demonstrating a form of Meta-Prompting by having the AI analyze and then apply a style.
...
- **Summarize Documents/Articles:** This prompt helps you quickly grasp the main points of long texts. It's useful for research, reviewing meeting notes, or understanding lengthy articles without reading every word. This uses First Principles by clearly defining the task and desired output format.
...
- **Get Book Summaries:** Get quick, insight-packed summaries of books. This is great for recalling key information or deciding if a book is relevant to your interests. This is a straightforward application of First Principles.
...
- **Simplify Complex Texts:** This prompt helps you understand difficult concepts by having the AI rewrite them in simpler terms. It's perfect for learning new subjects or making information accessible to a wider audience. This applies First Principles by specifying the target audience and desired simplification level.
...
- **Eliminate Writer's Block:** When you're stuck on a title, an opening, or a specific phrase, this prompt can help you brainstorm creative solutions and get your writing flowing again. This uses First Principles by clearly stating the problem and the desired output (e.g., a list of titles).
...
- **Learn Faster (80/20 Principle):** This prompt helps you quickly grasp the most important concepts of a topic, focusing on the 20% of information that will give you 80% of the understanding. It's a great way to get a high-level overview efficiently. This applies First Principles by defining the learning strategy.

  ```text
  "I want to learn about [insert topic]. Identify and share the most important 20% of learnings from this topic that will help me understand 80% of it."
  ```

- **Learn Complex Topics Simply:** Use this prompt to break down complicated subjects into easy-to-understand explanations. It's ideal for beginners or for quickly getting a grasp of new concepts. This uses First Principles by specifying the target audience and desired simplification level.

```text
"Explain [insert topic] in simple and easy terms that any beginner can understand."
```

- **Learn New Skills (30-Day Plan):** This prompt helps you create a structured learning path for any new skill. The AI can break down the learning process into manageable daily steps, making skill acquisition more achievable. This applies Chain of Thought by requesting a step-by-step plan.
...
- **Make Better Decisions Faster:** Use this prompt to get a balanced perspective on a decision. The AI can quickly generate pros and cons, helping you weigh your options more effectively. This uses First Principles by clearly defining the desired output (pros and cons).
...
- **Generate New Ideas:** This prompt is your go-to for brainstorming. Whether you need creative solutions, new concepts, or different approaches, the AI can help you generate a diverse range of ideas. This uses First Principles by clearly stating the goal and desired quantity/type of ideas.
...
- **Improve Time Management & Productivity:** Get personalized advice on managing your time and boosting productivity. The AI can act as a consultant, offering strategies tailored to your needs. This uses First Principles by defining the AI's role and the type of advice needed.
...
- **Make Board Meetings More Useful:** Transform your meetings with AI-driven insights. This prompt helps you get strategic advice from an AI acting as an expert in corporate governance. This uses First Principles by defining the AI's role and the desired outcome (strategies for better meetings).
...
- **Drive Accountability & Ownership:** Get expert advice on fostering a culture of accountability within your team. The AI can suggest practical strategies to empower your team members. This uses First Principles by defining the AI's role and the desired outcome (strategies for accountability).
...
- **Communicate Value Proposition Clearly:** Refine your messaging with AI assistance. This prompt helps you articulate your value proposition concisely and effectively, ensuring your audience understands your unique offering. This uses First Principles by clearly stating the goal and providing the current value proposition for refinement.
...
- **Make Difficult Conversations Less Difficult:** Prepare for challenging discussions with AI guidance. This prompt helps you structure conversations to be empathetic and clear, increasing the likelihood of a positive outcome. This uses Chain of Thought by requesting a structured approach to the conversation.
...
- **Develop Robust Growth Strategy:** Get strategic guidance from the AI to build a comprehensive business growth plan. The AI can help you identify key factors and steps for success. This uses First Principles by defining the AI's role and the desired outcome (a growth strategy).
